...
class UsersEdit extends React.Component {
    constructor(props){
        super(props)
        this.state = { message:"", user:{}, success:false };
    ...
    handleClick(){
        ...
        if(check){
            updateUser(this.props.match.params.id, this.state.user).then(data => {
                if(data.status){
            ...
            <div class="container">
                ...
                <div class="alert alert-danger" style={{display:(this.state.message=="")?'none':'block'}}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  className="form-control" placeholder="User Name" value={this.state.user.user_name} name="user_name" onChange={this.handleChange}/>
                    </div>
                    <div class="form-group">
                        <label>User Surname: </label> 
                        <input type="text"  className="form-control" placeholder="User Surname" value={this.state.user.user_surname} name="user_surname" onChange={this.handleChange}/>
                    </div>
                    <div class="form-group">
